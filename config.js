...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("254100736783")
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/db4c0b64b27732a938fca.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'SHANK_BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'GK-FY' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? true : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'GK🕊️' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'FY🕊️' : process.env.PACK_NAME.split(";")[1],
